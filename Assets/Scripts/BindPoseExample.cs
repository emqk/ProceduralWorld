...
public class BindPoseExample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject obj = new GameObject("TEST_MESH");
    ...
    /*    AnimationCurve curve = new AnimationCurve();
        curve.keys = new Keyframe[] { new Keyframe(0, 0, 0, 0), new Keyframe(1, 0.5f, 0, 0), new Keyframe(2, 0.0F, 0, 0) };

        // Create the clip with the curve
        AnimationClip clip = new AnimationClip();
        clip.SetCurve("Lower", typeof(Transform), "m_LocalPosition.x", curve);
        clip.legacy = true;
