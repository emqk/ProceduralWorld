...
{
    public NormalTreeGenerationData normalTreeGenData = new NormalTreeGenerationData { widthRange = new Vector2Int(6, 6), heightRange = new Vector2Int(5, 5), radius = 1, segmentHeight = 1
